...
\begin{tabular}{ll}
 ...
 \begin{tabular}{l} \linespread{1.2}\fontsize{42}{20}\selectfont \textbf{window-fourrier} \\ Fragmentation: 30 fragments -- 1000 bases \\ Conversion: \texttt{"A" -> 1, "T" -> -1, "G" -> I, "C" -> -I} \\ Fourier transform: $Ft$\texttt{(<<each fragment>>)} \end{tabular}\\
