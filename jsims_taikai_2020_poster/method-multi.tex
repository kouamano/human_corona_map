...
\begin{tabular}{ll}
 ...
 \begin{tabular}{l} \linespread{1.2}\fontsize{42}{20}\selectfont \textbf{Selection of frequent homologues} \\ \linespread{1.2}\fontsize{32}{20}\selectfont Vertebrate: \texttt{base-hit count >= 5; seq-lenght >= 5}  \\ \linespread{1.2}\fontsize{32}{20}\selectfont Viruses: \texttt{base-hit count >= 18; seq-lenght >= 5} \end{tabular} \\
\end{tabular}
\vspace{5mm}
\end{minipage} }
